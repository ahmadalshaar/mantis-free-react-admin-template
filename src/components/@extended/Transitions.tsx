...
const PopupTransition = forwardRef<HTMLDivElement, PopupTransitionProps>(function PopupTransition(
  { children, timeout = 200, ...props },
  ref
) {
  return (
    <Zoom ref={ref} timeout={timeout} {...props}>
      {children}
    </Zoom>
  );
});

export { PopupTransition };